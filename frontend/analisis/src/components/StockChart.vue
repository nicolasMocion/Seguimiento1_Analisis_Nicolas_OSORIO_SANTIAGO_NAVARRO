...
const updateChart = async () => {
  ...
  try {
    const requests = selectedSymbols.value.map(sym => axios.get(`https://seguimiento1analisisnicolasosoriosantiagona-production-d160.up.railway.app/api/assets/${sym}`))
