...
const fetchRiskProfile = async (symbolsArray) => {
  ...
  try {
    const res = await axios.post('https://seguimiento1analisisnicolasosoriosantiagona-production-d160.up.railway.app/api/analysis/risk-profile', symbolsArray)
...
const fetchPatterns = async () => {
  ...
  try {
    const res = await axios.get(`https://seguimiento1analisisnicolasosoriosantiagona-production-d160.up.railway.app/api/analysis/patterns/${selectedSymbol.value}?days=${windowSize.value}`)
